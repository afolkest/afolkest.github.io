...
<head>
    ...
    <link rel="preload" href="/fonts/heliotrope/heliotrope_ot_6_semibold.woff2" as="font" type="font/woff2" crossorigin>
...
def update_sitemap(essay_posts):
    ...
    urls = [
        ...
        (f"{SITE_URL}/art/cezanne-in-crystal.html", "0.6"),
        (f"{SITE_URL}/art/cat-in-crystal.html", "0.6"),
        (f"{SITE_URL}/art/hammershoi-in-crystal.html", "0.6"),
        ...
        (f"{SITE_URL}/art/la-cigale.html", "0.6"),
        (f"{SITE_URL}/art/william-james.html", "0.6"),
        (f"{SITE_URL}/art/spirits.html", "0.6"),
        (f"{SITE_URL}/art/lunch-atop-a-skyscraper.html", "0.6"),
        (f"{SITE_URL}/art/dice.html", "0.6"),
